...
const Karmic = () => {
    return (
        <div className='lg:pb-[78px] sm:pb-12 py-6 lg:pt-20 sm:pt-8 relative -mt-5' id='about'>
            ...
            <div className="container relative">
                ...
                <div className="flex max-xl:flex-wrap lg:pt-10 pt-9 max-xl:justify-center items-center max-w-[1140px] mx-auto w-full gap-4">
