...
const Hero = () => {
  return (
    <div className='lg:bg-hero-bg-layer bg-no-repeat max-lg:bg-center bg-cover 2xl: lg:min-h-[746px] bg-hero-bg-set relative max-lg:bg-light-gray' id='home'>
          ...
          <div className='lg:w-[570px] w-full flex flex-col justify-center'>
            <div className='flex flex-col justify-center max-lg:items-center'>
              <h1 className='lg:text-custom-2xl sm:text-5xl text-4xl lg:leading-custom-7xl text-white uppercase lg:max-w-[570px] max-lg:text-center font-sunflower'>We are believers decentralization
                <img className='lg:ms-[142px] md:ms-[343px] sm:ms-[285px] ms-[155px] lg:max-w-[158px] sm:max-w-[125px] max-w-24 w-full pointer-events-none' src="/assets/images/svg/main-heading-bottom-line.svg" alt="second-line" /> And Web3.
                <img className='lg:ms-[111px] md:ms-[343px] sm:ms-[285px] ms-[155px] lg:max-w-[169px] sm:max-w-[125px] max-w-24 w-full pointer-events-none' src="/assets/images/svg/main-heading-top-line.svg" alt="first-line" />
              </h1>
