...
const Hero = () => {
  return (
    <div className='lg:bg-hero-bg-layer bg-no-repeat max-lg:bg-center lg:min-h-[726px] bg-hero-bg-set relative max-lg:bg-light-gray' id='home'>
        ...
        <div className='lg:flex-row flex-col flex justify-between lg:pt-[124px] md:pt-20 pt-12 gap-5'>
          <div className='lg:w-[570px] w-full flex flex-col justify-center'>
            <div className='flex flex-col justify-center max-lg:items-center'>
              <h1 className='lg:text-custom-2xl font-light sm:text-5xl text-4xl lg:leading-custom-7xl text-white uppercase lg:max-w-[570px] max-lg:text-center font-sunflower'>We are believers decentralization
                <img className='lg:ms-[160px] md:ms-[343px] sm:ms-[285px] ms-[155px] lg:max-w-[158px] sm:max-w-[125px] max-w-24 w-full pointer-events-none -my-1' src="/assets/images/svg/main-heading-bottom-line.svg" alt="second-line" /> And Web3.
                <img className='lg:ms-[132px] md:ms-[343px] sm:ms-[285px] ms-[155px] lg:max-w-[179px] sm:max-w-[125px] max-w-24 w-full pointer-events-none -my-3' src="/assets/images/svg/main-heading-top-line.svg" alt="first-line" />
              </h1>
          ...
          <div className='lg:w-[398px] w-full flex max-lg:justify-center max-lg:items-center'>
            <img className='max-w-[398px] w-full pointer-events-none' src="/assets/images/png/hero-main-image.png" alt="hero-main-image" />
          </div>
